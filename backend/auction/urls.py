...
from .views import AuctionViewSet, AuctionListView, ArticleListView, UserListView, WalletListView, AuctionCreateView, ArticleCreateView, UserCreateView, WalletCreateView
